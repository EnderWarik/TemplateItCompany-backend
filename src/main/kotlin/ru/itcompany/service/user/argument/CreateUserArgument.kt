...
class CreateUserArgument private constructor(
    val email: String,
    val password: String,
    ...
    data class Builder(
        ...
        fun build() = CreateUserArgument( email, password, role, firstName, lastName, thirdName, address, phoneNumber, inn, organizationName)
    }
